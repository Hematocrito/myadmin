...
import {
  Form, Input, Button, Select, message, Switch, Row, Col, DatePicker as AntDatePicker
} from 'antd';
import {
    ...
    return (
      ...
      >
        <Row>
          ...
          <Col xs={8} md={8}>
            <Form.Item name="verifiedDocument" label="Verified ID Documents?" valuePropName="checked" help="Accept to make the model visible to users">
              <Switch />
            </Form.Item>
          </Col>
          <Col xs={8} md={8}>
