    ...
    return (
      <>
        ...
        <Row gutter={24} className="dashboard-stats">
          <Col span={8}>
            <Link legacyBehavior href="/users?status=active">
              <a>
                <Card>
                  <Statistic
                    title="ACTIVE USERS"
          ...
          <Col span={8}>
            <Link legacyBehavior href="/users?status=inactive">
              <a>
                <Card>
                  <Statistic
          ...
          <Col span={8}>
            <Link legacyBehavior href="/users?status=pending-email-confirmation">
              <a>
                <Card>
                  <Statistic
          ...
          <Col span={8}>
            <Link legacyBehavior href="/performer?status=active">
              <a>
                <Card>
                  <Statistic
                    title="ACTIVE MODELS"
          ...
          <Col span={8}>
            <Link legacyBehavior href="/performer?status=inactive">
              <a>
                <Card>
                  <Statistic
          ...
          <Col span={8}>
            <Link legacyBehavior href="/performer?status=pending-email-confirmation">
              <a>
                <Card>
                  <Statistic
          ...
          <Col span={8}>
            <Link legacyBehavior href="/subscription">
              <a>
                <Card>
                  <Statistic
                    title="SUBSCRIPTIONS"
          ...
          <Col span={8}>
            <Link legacyBehavior href="/earning">
              <a>
                <Card>
                  <Statistic
                    title="GROSS PROFIT"
          ...
          <Col span={8}>
            <Link legacyBehavior href="/order?deliveryStatus=created">
              <a>
                <Card>
                  <Statistic
          ...
          <Col span={8}>
            <Link legacyBehavior href="/order?deliveryStatus=shipping">
              <a>
                <Card>
                  <Statistic
          ...
          <Col span={8}>
            <Link legacyBehavior href="/order?deliveryStatus=delivered">
              <a>
                <Card>
                  <Statistic
          ...
          <Col span={8}>
            <Link legacyBehavior href="/order?deliveryStatus=refunded">
              <a>
                <Card>
                  <Statistic
