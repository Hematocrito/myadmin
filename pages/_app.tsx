...
import 'pages/auth/index.less';

import 'src/components/common/base/loader.less';
import 'src/components/common/base/scroll-bar.less';
import 'src/components/common/layout/header.less';
import 'src/components/common/layout/sider.less';
import 'src/layouts/primary-layout.less';
import 'src/components/common/layout/page.less';
import '../style/index.less';
import 'pages/report/index.less';
import 'src/components/user/index.less';
import 'src/components/performer/index.less';
import 'src/components/feed/index.less';
import 'src/components/file/index.less';
import 'pages/categories/index.less';
